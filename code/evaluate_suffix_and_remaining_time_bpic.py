...
model = load_model('output_files/models/model_bpic_29-1.67.h5', compile=False)
...
# make predictions
with open('output_files/results/suffix_and_remaining_time_BPIC_%s' % eventlog, 'w', newline='', encoding='utf-8') as csvfile:
