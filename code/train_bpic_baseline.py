...
with open('output_files/folds/fold1_bpic.csv', 'w', newline='', encoding='utf-8') as csvfile:
...
with open('output_files/folds/fold2_bpic.csv', 'w', newline='', encoding='utf-8') as csvfile:
    spamwriter = csv.writer(csvfile, delimiter=',', quotechar='|', quoting=csv.QUOTE_MINIMAL)
...
with open('output_files/folds/fold3_bpic.csv', 'w', newline='', encoding='utf-8') as csvfile:
    spamwriter = csv.writer(csvfile, delimiter=',', quotechar='|', quoting=csv.QUOTE_MINIMAL)
...
model_checkpoint = ModelCheckpoint('output_files/models/model_bpic_{epoch:02d}-{val_loss:.2f}.h5', monitor='val_loss', verbose=0, save_best_only=True, save_weights_only=False, mode='auto')
