...
model = load_model('output_files/models/model_17-1.51.h5', compile=False)
...
# make predictions
with open('output_files/results/suffix_and_remaining_time_%s' % eventlog, 'w', newline='', encoding='utf-8') as csvfile:
